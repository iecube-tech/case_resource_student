<template>
    <div class="question-card p-6 border-b border-gray-200" style="border-left-color: #10b981;">
        <div class="mb-4">
        ...
        <div v-if="!isFinish" class="space-y-2" id="question-options">
            <div v-for="option in question.options" @click="selectOption(option.label)"
                ...
                :class="option.label == question.response ? 'selected' : ''">
...
const selectOption = (label: string) => {
    ...
    if (props.question.response == label) {
        props.question.response = null
    } else {
        props.question.response = label
    }
    debouncedHandle()
}
