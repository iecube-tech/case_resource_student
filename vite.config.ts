  ...
  server: {
    ...
    proxy: {
      ...
      '/local-resource': {
        ...
        target: 'http://192.168.1.19:8088/files',
      ...
      '/so-cket': {
        ...
        target: 'http://192.168.1.19:8088/wsv1/',
        // target: 'http://47.94.161.154:8088/',
        // target: "http://192.168.124.8:8088",
        // target: "http://192.168.1.20:8088",
        // target: 'http://192.168.10.6:8088/',
      ...
      '/device-front': {
        ...
        target: 'http://192.168.1.19:8088/ws/front/',
      ...
      '/ai-assistant': {
        ...
        target: 'http://192.168.1.19:8088/ai/server/assistant/',
        ws: true,
        changeOrigin: true,
