      ...
      const PDFViewerApplication = {
        ...
        async save(options = {}) {
          ...
          try {
            ...
            //   type: "application/pdf"
            // });
            // let pstrId = parseInt(window.location.search.split("?")[2].split("=")[1])
            // let tag = window.location.search.split("?")[3]
            // console.log(tag);
            // let formData = new FormData();
            // formData.append('filename', filename);
            // formData.append('file', blob);
            // formData.append('pstRId', pstrId);
            ...
            console.error('catch save error')
          } finally {
        ...
        downloadOrSave(options = {}) {
          if (this.pdfDocument?.annotationStorage.size > 0) {
            ...
            this.save(options);
            console.log(parseInt(window.location.search.split("?")[2].split("=")[1]));
            console.log('1111');
          }
          // else {
